...
本目录记录《斗罗大陆：魂师对决》中极具代表性的魂师角色。依据 `unit_policy: representative` 规则，仅精选在版本 Meta、商业化卡池（SP+/SP 梯队）或阵容机制（打火/拉条/破甲/阵法）中发挥核心作用的代表性魂师。

## 代表性魂师列表

| 魂师名称 | 统一标识 (Slug) | 品质 | 职业定位 | 获取途径 | 商业化/版本权重 | 链接 |
|----------|-----------------|------|----------|----------|-----------------|------|
| **太初食神·奥斯卡** | `sp-plus-taichu-shishen-oscar` | SP+ | 辅助系 | 五周年限时卡池 | 五周年核心商化锚点，顶阶打火/增伤 | [详情](/entities/units/sp-plus-taichu-shishen-oscar.md) |
...
| **王林** | `sp-wanglin` | SP | 强攻系 | 《仙逆》联动卡池 | IP 跨界联动主 C，古神外观 | [详情](/entities/units/sp-wanglin.md) |
