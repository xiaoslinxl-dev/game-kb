...
《神庙逃亡2》（Temple Run 2 中文版）由 Imangi Studios 开发、乐逗游戏（创梦天地）中国本土化代理发行。作为一款经典的 3D 悬崖跑酷手游，其中国版本加入了大量的本土化系统与长线运营机制。
...
- **Systems (系统模块)**：
  ...
  - `content-modes`：涵盖无尽跑酷模式、竞技场/排位赛（单人/双人）、地图副本（如玩具王国、幽灵穹顶等）、黄金矿山挂机及限时收集赛等多重玩法。
