...
《神庙逃亡2》（Temple Run 2 中文版）由 Imangi Studios 开发、创梦天地（乐逗游戏）在中国大陆引进、本地化二次开发与长线运营。作为一款经典的 3D 悬崖跑酷手游，其中国版本加入了大量的本土化系统、多套主题赛道与长线运营机制。
...
- **Systems (系统模块)**：
  ...
  - `content-modes`：涵盖无尽跑酷模式、竞技场/排位赛（单人/双人）、主题地图副本（如玩具王国、迷失丛林、百花戈壁、幽灵穹顶、深海遺跡等）、黄金矿山挂机及限时收集赛等多重玩法。
