...
欢迎来到《斗罗大陆：猎魂世界(官服)》LLM Wiki 知识库 bundle。

## 1. 核心架构文档 (Core)

- [Manifest 配置文件](/manifest.md) — 知识库模块选择与版本元数据
- [Overview 游戏概述](/overview.md) — 游戏定位、发行状态与基本信息
- [Core Loop 核心循环](/core-loop.md) — 玩法循环链与每日/周常体验
- [Progression 养成体系](/progression.md) — 角色等级、武魂升星、魂环/魂核/魂骨养成
...
- [Sources 引用来源](/sources.md) — 官方与社区资料来源清单
...
- [竞技匹配系统](/systems/matchmaking.md) — 斗魂对决跨服赛季 PvP 机制
