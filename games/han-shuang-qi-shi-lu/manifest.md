...
2. **系统模块（Systems Modules）**：
   ...
   - `matchmaking`：竞技场积分匹配、跨服/跨王国战（KvK / SvS）、王国转移（State Transfer，2026年9月13–19日第20组分组，涵盖States 4–4326，今日00:00 UTC正式开启第一阶段战备预览）、领航荣耀体系（Leading Glory System）、霜龙争霸赛区匹配池与跨服矿区/联赛匹配机制。
...
- **跨服王国转移（State Transfer）第一阶段（Phase I）今日正式开启**：第20组（涵盖States 4–4326）移民窗口于今日（2026年9月13日 00:00 UTC / 北京时间 08:00）正式进入第一阶段（Phase I: 准备与预览期）。各王国管理层正在最终公布战力上限（Power Cap）并核定普通与特殊邀请配额，全服领主正式进入目标王国全景预览、测算移民卷轴需求（基于Transfer Score消耗2至50+张不等），并与目标执政联盟展开外交沟通对接阶段。
- **活跃礼包码核实与近期失效更新**：限时大额资源礼包码 `4dp5ZGM4c` **已于9月12日23:59 UTC正式到期失效**，知识库已更新警示避免领主无效尝试；`WOS0909`（9月9日上线）持续稳定有效；常驻与社区专属码保持活跃；线下诚品动漫祭西门店“熊先生书屋”持续开展9月消费礼并配发“寒霜英雄款”专属兑换码。
