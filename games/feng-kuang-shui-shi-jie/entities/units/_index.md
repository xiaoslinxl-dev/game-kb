...
| 海兽名称 | Slug | 职能/定位 | 稀有度 | 获取途径 | 付费关联度 (pay_relevance) | 核心加成机制 |
|---|---|---|---|---|---|---|
| **鳌蟹** | [ao-xie](/entities/units/ao-xie.md) | 综合防御/免控 | 超凡 (Transcendent) | S2赛季培育室、充值礼包 | 极高 | 全队双抗大幅提升，赋予高额吸收护盾与霸体免控，防守第一选择 |
| **海豚** | [hai-tun](/entities/units/hai-tun.md) | 回血减伤/续航 | 传说 (Legendary) | 海兽培育室（23级解锁） | 中等（平民通用） | 持续为 3 名友军百分比回血并附加强力减伤，万金油续航海兽 |

## 3. 实体养成与跨文档索引

- 英雄养成机制与词条洗练规则详见 [数值与养成系统](/progression.md)。
- 英雄在战斗阵型中的战术站位与阵法选择详见 [对抗与卡牌战斗系统](/systems/session-combat.md)。
- 英雄与海兽的抽卡/转盘获取与付费门槛详见 [商业化与付费变现](/monetization.md)。
