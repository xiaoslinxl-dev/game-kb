...
2. **系统模块（Systems Modules）**：
   ...
   - `matchmaking`：竞技场积分匹配、跨服/跨王国战（KvK / SvS）、王国转移（State Transfer，2026年9月13–19日第20组分组，涵盖States 4–4326，当前处于第一阶段Phase I准备与预览期第二日，距离第二阶段定向邀请不足37小时）、领航荣耀体系（Leading Glory System）、霜龙争霸赛区匹配池与跨服矿区/联赛匹配机制。
...
- **跨服王国转移（State Transfer）第一阶段（Phase I）进入第二日冲刺**：第20组（涵盖States 4–4326）移民窗口进入准备与预览期第2天（距9月15日23:59 UTC第一阶段截止仅余约37小时）。各王国管理层正在锁定35个普通邀请与3个特殊邀请配额（领航王国20个普通邀请），意向领主正在加速完成Transfer Score与移民卷轴（2至50+张）核算，清理非安全资源以备9月16日00:00 UTC第二阶段定向邀请开启时平稳转服。
